...
public class OllamaContractInfoExtractor implements ContractInfoExtractor {
    ...
    private String buildPrompt(String contractText) {
        ...
        return """
               ...
               [중요] companyName에는 절대로 "오픈소스컨설팅"을 넣지 마라.
               "오픈소스컨설팅"은 우리 회사이며, 우리가 찾는 업체명은 항상 "상대방 회사"다.
               ...
               - 업체명 앞에 "주식회사", "(주)" 등 법인 표기가 붙어 있으면 그 표기까지 포함해서 업체명에 그대로 넣어라.
                 (예: "주식회사 그린테크" → "그린테크"로 줄이지 말고 "주식회사 그린테크" 그대로 사용)

               [예시 1]
               원문: "갑: 오픈소스컨설팅 / 을: 주식회사 그린테크"
               정답: {"companyName": "주식회사 그린테크", ...}  (갑이 오픈소스컨설팅이므로 을을 선택)

               [예시 2]
               원문: "갑: 주식회사 가람물산 / 을: 오픈소스컨설팅"
               정답: {"companyName": "주식회사 가람물산", ...}  (을이 오픈소스컨설팅이므로 갑을 선택)
               ...
               [최종 확인] 답을 출력하기 전에 다시 한번 확인하라: companyName이 "오픈소스컨설팅"이면 안 된다.
               그 경우 갑/을 중 나머지 한 쪽으로 다시 선택하라.
